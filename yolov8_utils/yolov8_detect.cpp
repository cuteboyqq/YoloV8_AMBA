...
////////////////////////
YOLOV8_DETECT::YOLOV8_DETECT(ADAS_Config_S *config)  // main function
{
...
YOLOV8_DETECT::~YOLOV8_DETECT()  // clear object memory
{
  delete m_decoder;
  delete m_laneBuff;
  delete m_lineBuff;
...
//               Tensor Settings
// ============================================
bool YOLOV8_DETECT::_initModelIO()
{
...
bool YOLOV8_DETECT::_getITensor(float *yoloOutputBuff, const zdl::DlSystem::ITensor* tensor)
{
...
bool YOLOV8_DETECT::_getOutputTensor()
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
bool YOLOV8_DETECT::run(cv::Mat &imgFrame)
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
//                Load Inputs
// ============================================
bool YOLOV8_DETECT::loadInput(std::string filePath)
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
bool YOLOV8_DETECT::loadInput(cv::Mat &imgFrame)
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
bool YOLOV8_DETECT::_loadImageFile(const std::string& inputFile)
{
  auto m_logger = spdlog::get("YOLO-ADAS");
  auto time_0 = std::chrono::high_resolution_clock::now();
...
//               Pre Processing
// ============================================
bool YOLOV8_DETECT::preProcessingFile(std::string imgPath)
{
...
bool YOLOV8_DETECT::preProcessingMemory(cv::Mat &imgFrame)
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
bool YOLOV8_DETECT::_imgPreprocessing()
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
//               Post Processing
// ============================================
bool YOLOV8_DETECT::postProcessing()
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
void YOLOV8_DETECT::_SEG_postProcessing()
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
void YOLOV8_DETECT::_OD_postProcessing()
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
void YOLOV8_DETECT::_rescaleBoundingBox(
    int bbx_num,
    struct v8xyxy *out,
...
float YOLOV8_DETECT::_getBboxOverlapRatio(BoundingBox &boxA, BoundingBox &boxB)
{
...
void YOLOV8_DETECT::_bboxMerging(BoundingBox &bboxA, BoundingBox &bboxB, int label, BoundingBox &bboxMerge)
{
  int newX1 = 0;
  int newY1 = 0;
  int newX2 = 0;
...
void YOLOV8_DETECT::_getMainLaneAndLine(
...
void YOLOV8_DETECT::_updateYBottom(int yBottom)
{
...
void YOLOV8_DETECT::_calcLaneInfo(cv::Mat &inputLane, cv::Mat &inputLine)
{
  int rows = inputLane.size[0];
  int columns = inputLane.size[1];
...
//              Lane Calibration
// ============================================
void YOLOV8_DETECT::_noiseRemoval(cv::Mat &laneMask)
{
...
void YOLOV8_DETECT::_masksMerging(cv::Mat &laneMask)
{
...
void YOLOV8_DETECT::_calibrateLaneMask()
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
//                  Outputs
// ============================================
bool YOLOV8_DETECT::getLaneMask(cv::Mat &mask)
{
  mask = m_laneColor;
  return true;
}
...
bool YOLOV8_DETECT::getLineMask(cv::Mat &mask)
{
  mask = m_lineColor;
  return true;
}
...
bool YOLOV8_DETECT::getMainLaneMask(cv::Mat &mask)
{
  mask = m_mainLaneMask;
  return true;
}
...
bool YOLOV8_DETECT::getMainLineMask(cv::Mat &mask)
{
  mask = m_mainLineMask;
  return true;
}
...
bool YOLOV8_DETECT::getHorizontalLineMask(cv::Mat &mask)
{
  mask = m_horiLineMask;
  return true;
}
...
void YOLOV8_DETECT::getLaneLineInfo(LaneLineInfo &laneLineInfo)
{
...
bool YOLOV8_DETECT::getVehicleBoundingBox(
...
bool YOLOV8_DETECT::getRiderBoundingBox(
  vector<BoundingBox> &_outBboxList,
  float confidence,
  int videoWidth, int videoHeight,
  BoundingBox &fcwROI)
...
bool YOLOV8_DETECT::getHumanBoundingBox(
  vector<BoundingBox> &_outBboxList,
  float confidence,
  int videoWidth, int videoHeight,
  BoundingBox &fcwROI)
...
bool YOLOV8_DETECT::getRoadSignBoundingBox(
  vector<BoundingBox> &_outBboxList,
  float confidence,
  int videoWidth,
  int videoHeight,
...
void YOLOV8_DETECT::genResultImage(cv::Mat &img, vector<BoundingBox> bboxList, int colorIdx)
{
...
void YOLOV8_DETECT::genTrackObjectImage(cv::Mat &imgFrame, vector<Object> objectList)
{
  auto m_logger = spdlog::get("YOLO-ADAS");
...
void YOLOV8_DETECT::_colorize(cv::Mat &inputLane, cv::Mat &inputLine, cv::Mat &outputLane, cv::Mat &outputLine)
{
...
void YOLOV8_DETECT::debugON()
{
  m_debugMode = true;
}


void YOLOV8_DETECT::showProcTime()
{
  m_estimateTime = true;
}